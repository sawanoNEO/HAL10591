...
std::list<GamePad::State> Input::m_stackState;
...
void Input::EditBufferFrame(const char* ActionName, Button, ButtonState,int _bufferframe)
{
	ImGui::SliderInt(ActionName,&_bufferframe,0,60);
